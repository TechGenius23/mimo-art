...
const Allartandcraft = () => {
    return (
        <div>
            <div className="relative flex flex-col items-center max-w-lg gap-4 p-6 rounded-md shadow-md sm:py-8 sm:px-12 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-40 h-40 fill-current shrink-0 text-violet-400 dark:text-violet-600">
                ...
                <p className="flex-1 text-center text-gray-400 dark:text-gray-600">Tempora ipsa quod magnam non, dolores nemo optio. Praesentium soluta maiores non itaque aliquam sint.</p>
                <button type="button" className="px-8 py-3 font-semibold rounded-full bg-violet-400 dark:bg-violet-600 text-gray-900 dark:text-gray-50">Start recycling</button>
            </div>
        </div>
    );
};
