            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
                ...
                <form onSubmit={handlesubmit} noValidate="" action="" className="space-y-6">
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="text" name="name" id="username" placeholder="name" className="w-full px-4 py-3 rounded-md border-red-700 dark:border-gray-300 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800 focus:border-violet-400 focus:dark:border-violet-600" />
                    </div>
                    <div className="space-y-1 text-sm">
                        <label htmlFor="username" className="block text-gray-400 dark:text-gray-600">E-mail</label>
                        <input type="text" name="email" id="username" placeholder="email" className="w-full px-4 py-3 rounded-md border-red-700 dark:border-gray-300 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800 focus:border-violet-400 focus:dark:border-violet-600" />
                    </div>
                    <div className="space-y-1 text-sm">
