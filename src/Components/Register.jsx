...
const Register = () => {
    const {creatUser, googlelogin, twitterlogin, githublogin,setUser} = useContext(AuthContext);
            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
                ...
                <form onSubmit={handlesubmit} noValidate="" action="" className="space-y-6">
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="text" name="name" id="username" placeholder="name" className="w-full px-4 py-3 rounded-md border-red-700 dark:border-gray-300  dark:bg-orange-500 text-red-500 dark:text-gray-800 focus:border-violet-400 focus:dark:border-violet-600" />
                    </div>
                    <div className="space-y-1 text-sm">
                        <label htmlFor="username" className="block text-gray-400 dark:text-gray-600">E-mail</label>
                        <input type="email" name="email" id="username" placeholder="email" className="w-full px-4 py-3 rounded-md border-red-700 dark:border-gray-300 bg-gray-900 dark:bg-gray-50 text-red-500 dark:text-gray-800 focus:border-violet-400 focus:dark:border-violet-600" />
                    </div>
                    <div className="space-y-1 text-sm">
                        ...
                        <div className="flex items-center">
                            ...
                            <label htmlFor="remember" className="text-sm dark:text-gray-600">Terms and Condition</label>
                        </div>
                    </div>
                    <button className="block w-full p-3 text-center rounded-sm text-gray-900 dark:text-gray-50 bg-violet-400 dark:bg-violet-600">Register</button>
                </form>
                {
                ...
                <p className="text-xs text-center sm:px-6 text-gray-400 dark:text-gray-600">Have an account?
                    <NavLink to={'/login'}><a rel="noopener noreferrer" href="#" className="underline text-gray-100 dark:text-gray-800">Log In</a></NavLink>
                </p>
            </div>
        </div>
    );
